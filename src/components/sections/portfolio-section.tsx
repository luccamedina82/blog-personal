...
import { ArrowUpRight, BookMarked, FileText, Mic2 } from 'lucide-react'

const STACK = ['TypeScript', 'React', 'Next.js', 'NestJS', 'Node.js', 'PostgreSQL', 'Docker', 'Rust']

const PROJECTS = [
  {
    title: 'Compiler Playground',
    description:
      'Interactive lexer/parser visualizer for a toy language. Step through tokens, AST, and IR live in the browser.',
    stack: ['TypeScript', 'WASM', 'Rust'],
    year: '2025',
  },
  {
    title: 'NestJS Auth Kernel',
    description:
      'Production-grade authentication module with refresh rotation, RBAC, audit log, and OWASP-aligned defaults.',
    stack: ['NestJS', 'PostgreSQL', 'Redis'],
    year: '2025',
  },
  {
    title: 'Edge Cache Profiler',
    description:
      'Distributed tracing tool that maps cache hit ratios across edge nodes and surfaces revalidation hotspots.',
  ...
  },
  {
    title: 'Lexicon',
    description:
      'Self-hosted vocabulary trainer with spaced repetition tuned for technical and literary English corpora.',
...
const ACTIVITY = [
  {
    icon: BookMarked,
    label: 'Last book summarized',
    title: 'The Pragmatic Programmer — Hunt & Thomas',
    meta: '2 days ago',
  },
  {
    icon: FileText,
    label: 'Latest technical post',
    title: 'Demystifying SSA form in modern compilers',
    meta: '5 days ago',
  },
  {
    icon: Mic2,
    label: 'Shadowing session',
    title: 'BBC interview — 12:41 reviewed',
    meta: 'Yesterday',
  },
]
