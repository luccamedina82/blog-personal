      ...
      <div className="px-6 lg:px-12 pt-10">
        ...
        {!isLanding && (
          <div className="mt-8 flex gap-0 border-b border-border overflow-x-auto">
            <Link
              to="/english"
              className="px-4 py-2.5 text-sm whitespace-nowrap shrink-0 text-muted-foreground hover:text-foreground transition-colors"
            >
              ←
            </Link>
            {TABS.map((tab) => {
